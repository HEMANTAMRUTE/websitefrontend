...
useEffect(()=>{
  ...
  const response=await axios.get(`https://internarea-ztdw.onrender.com/api/internship/${id}`)
...
const submitApplication= async()=>{
  const text=document.getElementById("text")
    if (text.value==="") {
      ...
      await axios.post("https://internarea-ztdw.onrender.com/api/application",bodyJson).then((res)=>{

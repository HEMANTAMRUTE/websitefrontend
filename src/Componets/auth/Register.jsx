...
const closeLogin=()=>{
  ...
  return (
    <div>
      <div className="form">
        <h1>{t('Sing-up and Apply For Free')}</h1>
...
<label htmlFor="Lname" className='border-b text-gray-700 text-sm font-bold mb-2'>{t('Last Name')}</label>
              ...
              <small>{t('By signing up, you agree to our')} <span className='text-blue-400'>{t('Term and Conditions.')}
                ...
                <button className='bg-blue-500 h-9 text-white font-bold py-2 mt-4 px-4 w-full rounded hover:bg-blue-600'>{t('Sing Up')} </button>

...
const text=document.getElementById("text")
 ...
 <div className="flex tedxt-sm justify-between">
  ...
  <p className='mt-3 text-slate-400' > <i class="bi bi-calendar-check-fill"></i>  {t('Experience')}  <br />
  {data.Experience}</p>
 ...
 <p className='mt-4'> {data.aboutCompany}</p>
  ...
  <div className="application-page">
    <div className="bg">
      ...
      <p>{t('Applyion for Company')} {data.company}</p>
    ...
    <div className="moreSteps">
      ...
      <p>{t('confirme your availiblity')}</p>

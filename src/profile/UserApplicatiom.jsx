...
function UserApplicatiom() {
  const {t}=useTranslation();
    ...
    useEffect(()=>{
        ...
        try {
            const response=await axios.get("https://websitebackend-v27m.onrender.com/api/application")
       ...
       <div class="p-4 lg:w-1/2 md:w-full">
         <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
           ...
           <div class="flex-grow">
             ...
             <Link to={`/UserapplicationDetail?a=${data._id}`} class="mt-3 text-indigo-500 inline-flex items-center">{t('View in deatil')}

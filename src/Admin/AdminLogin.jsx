...
if (username===""||password==="") {
    ...
    axios.post("https://websitebackend-v27m.onrender.com/api/admin/adminLogin",bodyjson).then((res)=>{
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">{t('Contact Us')} </h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">{t('Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify.')} </p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="pass" class="leading-7 text-sm text-gray-600">{t('Password')} </label>
